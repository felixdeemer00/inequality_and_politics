...
dat_g <- pol_and_ineq_mod %>%
  ...
  labs(title = "How does Income Inequality relate to Legislative Competitiveness?",
       subtitle = "Countries with more competitive legislative elections are more divergent in their inequality levels than others.",
       x = "Fraction of National Income Owned",
       y = "Probability") +
  facet_grid(
    liec ~ percentile, 
...
dat_h <- pol_and_ineq_mod %>%
  ...
  labs(title = "How does Income Inequality relate to Executive Competitiveness?",
       subtitle = "Countries with more competitive executive elections are ",
       x = "Fraction of National Income Owned",
       y = "Probability") +
  facet_grid(
    eiec ~ percentile, 
